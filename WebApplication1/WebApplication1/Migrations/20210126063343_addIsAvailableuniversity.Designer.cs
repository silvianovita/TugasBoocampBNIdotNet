...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20210126063343_addIsAvailableuniversity")]
    partial class addIsAvailableuniversity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.Profiling", b =>
                {
                    b.Property<string>("NIK")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApplication1.Models.Account", b =>
                {
                    b.HasOne("WebApplication1.Models.Person", "Person")
                        .WithOne("Account")
                        .HasForeignKey("WebApplication1.Models.Account", "NIK")
            ...
            modelBuilder.Entity("WebApplication1.Models.Education", b =>
                {
                    b.HasOne("WebApplication1.Models.University", "University")
                        .WithOne("Education")
                        .HasForeignKey("WebApplication1.Models.Education", "University_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Profiling", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Account", "Account")
                        .WithOne("Profiling")
                        .HasForeignKey("WebApplication1.Models.Profiling", "NIK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
